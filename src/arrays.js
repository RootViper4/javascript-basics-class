...
const reverseWordsInArray = strings => {
  return strings.map(strings =>
    strings
      ...
      .reverse()
      .join('')
  ); // This worked somehow creating a new array with map. FCC has good article on this but didn't use .map.
};
...
const sortByLastLetter = strings => {
  ...
  ); // Use charCodeAt. Returns a number associated with a character. Letters that occur later in the alphabet have higher value. Substack solution.
};
